...
export const QuestCard: React.FC<QuestCardProps> = ({ quest, isCompleted, isAvailable, onToggle }) => {
    ...
    return (
        <div
            className={`group/card relative rounded-lg border transition-all duration-300 flex flex-col overflow-hidden ${isCompleted
                    ? 'bg-[#0a0a0a] border-green-500/20 opacity-60 grayscale-[0.5]'
                    : isLocked
